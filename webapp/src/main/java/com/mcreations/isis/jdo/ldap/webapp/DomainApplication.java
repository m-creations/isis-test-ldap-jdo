 ...
 *  under the License.
 */
package com.mcreations.isis.jdo.ldap.webapp;
 ...
 *      &lt;param-value>com.mcreations.isis.jdo.ldap.webapp.DomainApplication&lt;/param-value>
 *    &lt;/init-param>
 * &lt;/filter>
 * </pre>
 * 
    ...
    protected Module newIsisWicketModule() {
        ...
        final Module overrides = new AbstractModule() {
            ...
            protected void configure() {
                bind(String.class).annotatedWith(Names.named("applicationName")).toInstance("Isis Test Ldap Jdo App");
                bind(String.class).annotatedWith(Names.named("applicationCss")).toInstance("css/application.css");
                bind(String.class).annotatedWith(Names.named("applicationJs")).toInstance("scripts/application.js");
                bind(String.class).annotatedWith(Names.named("welcomeMessage")).toInstance(readLines(getClass(), "welcome.html"));
                bind(String.class).annotatedWith(Names.named("aboutMessage")).toInstance("Isis Test Ldap Jdo App");
